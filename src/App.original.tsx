...
function App() {
  ...
  // Aplicar o nível de zoom ao elemento raiz
  // useEffect(() => {
  //   const rootElement = document.getElementById('root');
  //   if (rootElement) {
  //     rootElement.style.transform = `scale(${zoomLevel})`;
  //     rootElement.style.transformOrigin = 'top left';
  //     rootElement.style.height = `${100 / zoomLevel}vh`;
  //     rootElement.style.width = `${100 / zoomLevel}vw`;
  //   }
  // }, [zoomLevel]);
  
  // Fechar menu de zoom ao clicar fora
  // useEffect(() => {
  ...
  // Função para alterar o nível de zoom
  ...
  // Carregar preferência de zoom do localStorage
  // useEffect(() => {
  ...
  const areasAtuacao = [
    {
      title: t('areasAtuacao.areas.educacao.titulo'),
      icon: <BookOpen className="w-12 h-12 text-cyan-500" />,
      items: t('areasAtuacao.areas.educacao.itens', { returnObjects: true }) as string[]
    },
    {
      title: t('areasAtuacao.areas.saude.titulo'),
      icon: <Heart className="w-12 h-12 text-cyan-500" />,
      items: t('areasAtuacao.areas.saude.itens', { returnObjects: true }) as string[]
    },
    {
      title: t('areasAtuacao.areas.geracaoRenda.titulo'),
      icon: <DollarSign className="w-12 h-12 text-cyan-500" />,
      items: t('areasAtuacao.areas.geracaoRenda.itens', { returnObjects: true }) as string[]
    },
    {
      title: t('areasAtuacao.areas.assistenciaSocial.titulo'),
      icon: <Users2 className="w-12 h-12 text-cyan-500" />,
      items: t('areasAtuacao.areas.assistenciaSocial.itens', { returnObjects: true }) as string[]
    },
    {
      title: t('areasAtuacao.areas.direitosHumanos.titulo'),
    ...
    {
      title: t('areasAtuacao.areas.culturaEsporte.titulo'),
      icon: <Music className="w-12 h-12 text-cyan-500" />,
      items: t('areasAtuacao.areas.culturaEsporte.itens', { returnObjects: true }) as string[]
    },
    {
      title: t('areasAtuacao.areas.meioAmbiente.titulo'),
    ...
    const fetchPublicacoes = async () => {
      ...
      try {
        ...
        setPublicacoes([
          {
            id: 1,
            titulo: "Exemplo de Atividade 1",
            conteudo: "Esta é uma atividade de exemplo enquanto não conseguimos conectar à API.",
          ...
          {
            id: 2,
            titulo: "Exemplo de Atividade 2",
            conteudo: "Esta é uma segunda atividade de exemplo para demonstrar a paginação.",
            fotos: ["https://storage.googleapis.com/amodes18.firebasestorage.app/publicacoes/1746107498_388809cd.jpg"],
            autor_id: 1,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
          ...
          {
            id: 3,
            titulo: "Exemplo de Atividade 3",
            conteudo: "Esta é uma terceira atividade de exemplo para demonstrar a paginação.",
            fotos: ["https://storage.googleapis.com/amodes18.firebasestorage.app/publicacoes/1746107498_388809cd.jpg"],
            autor_id: 1,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
          ...
          {
            id: 4,
            titulo: "Exemplo de Atividade 4",
            conteudo: "Esta é uma quarta atividade de exemplo para demonstrar a paginação.",
            fotos: ["https://storage.googleapis.com/amodes18.firebasestorage.app/publicacoes/1746107498_388809cd.jpg"],
            autor_id: 1,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
          ...
          {
            id: 5,
            titulo: "Exemplo de Atividade 5",
            conteudo: "Esta é uma quinta atividade de exemplo para demonstrar a paginação.",
            fotos: ["https://storage.googleapis.com/amodes18.firebasestorage.app/publicacoes/1746107498_388809cd.jpg"],
            autor_id: 1,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
          ...
          setMembros([
            {
              ...
              descricao: "Mais de 15 anos de experiência em gestão de projetos sociais e desenvolvimento comunitário.",
              username: null,
              senha: "",
            ...
            },
            {
              ...
              descricao: "Especialista em implementação e monitoramento de projetos de desenvolvimento social.",
              username: null,
              senha: "",
      ...
      try {
        ...
        if (data && data.length > 0) {
          ...
          setCategorias([
            ...
            { id: 2, nome: "Projetos", created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: 3, nome: "Workshops", created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: 4, nome: "Equipe", created_at: new Date().toISOString(), updated_at: new Date().toISOString() }
          ]);
        }
      } catch (error) {
    ...
    <>
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <a href="#inicio" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.inicio')}
              </a>
              <a href="#sobre" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.sobre')}
              </a>
              <a href="#equipe" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.equipe')}
              </a>
              <a href="#atividades" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.atividades')}
              </a>
              <a href="#galeria" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.galeria')}
              </a>
              <a href="#contato" className="text-slate-700 hover:text-cyan-500 dark:text-slate-200 dark:hover:text-cyan-300 transition">
                {t('header.contato')}
              </a>
            </nav>
      ...
      <section id="inicio" className="pt-0">
        <div className="relative min-h-[75vh]">
          ...
          <div className="container mx-auto px-6 relative z-10 h-full flex flex-col justify-center" style={{ paddingTop: '5rem', paddingBottom: '5rem', minHeight: '75vh' }}>
            <div className="max-w-3xl" data-aos="fade-right">
              ...
              <a 
                href="#sobre"
                className="inline-block bg-white text-cyan-500 px-8 py-4 rounded-lg text-lg font-medium hover:bg-cyan-50 transition-all transform hover:scale-105 shadow-lg"
              >
                {t('hero.botao')}
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            >
              ...
              <p className="text-cyan-700 dark:text-cyan-200 mb-6">
                Sua doação ajuda a manter nossos projetos e impactar mais vidas.
              </p>
            ...
            >
              ...
              <p className="text-cyan-700 dark:text-cyan-200 mb-6">
                Conheça mais sobre nossos projetos e como podemos trabalhar juntos.
              </p>
              <button className="bg-cyan-500 text-white px-8 py-3 rounded-lg hover:bg-cyan-600 transition-all">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex space-x-3">
                      <a href="#" className="text-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400">
            ...
            <div className="space-y-6">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="nome" className="block text-cyan-700 dark:text-cyan-200 mb-2">{t('contato.formulario.nome')}</label>
                    <input
                      type="text"
                      id="nome"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-cyan-700 dark:text-cyan-200 mb-2">{t('contato.formulario.email')}</label>
                    <input
                      type="email"
                      id="email"
                      className="w-full px-4 py-3 rounded-lg border border-cyan-300 dark:border-cyan-600 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-cyan-700 dark:text-white"
                ...
                <div>
                  <label htmlFor="assunto" className="block text-cyan-700 dark:text-cyan-200 mb-2">{t('contato.formulario.assunto')}</label>
                  <input
                    type="text"
                    id="assunto"
                    className="w-full px-4 py-3 rounded-lg border border-cyan-300 dark:border-cyan-600 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-cyan-700 dark:text-white"
                ...
                <div>
                  <label htmlFor="mensagem" className="block text-cyan-700 dark:text-cyan-200 mb-2">{t('contato.formulario.mensagem')}</label>
                  <textarea
                    id="mensagem"
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-cyan-300 dark:border-cyan-600 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-cyan-700 dark:text-white"
                ...
                <button
                  type="submit"
                  className="bg-cyan-500 text-white px-8 py-3 rounded-lg hover:bg-cyan-600 transition-all"
                >
                  {t('contato.formulario.enviar')}
                </button>
              </form>
            </div>
      ...
      {/* Donation Section */}
      <section id="doacoes" className="py-20 bg-cyan-50 dark:bg-cyan-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-cyan-900 dark:text-white">Faça uma Doação</h2>
            <div className="w-24 h-1 bg-cyan-500 mx-auto mb-4"></div>
            <p className="text-cyan-700 dark:text-cyan-200 max-w-2xl mx-auto">
              Sua contribuição ajuda a sustentar nossos projetos e iniciativas em prol do desenvolvimento sustentável em Moçambique.
            </p>
          </div>

          <div className="max-w-2xl mx-auto bg-white dark:bg-cyan-800 rounded-lg shadow-xl p-8">
            {donationSubmitted ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-2xl font-bold text-cyan-900 dark:text-white mb-4">Doação Recebida com Sucesso!</h3>
                <p className="text-cyan-700 dark:text-cyan-200 mb-6">
                  Agradecemos imensamente pela sua contribuição. Ela será de grande ajuda para nossas iniciativas.
                </p>
                <button
              ...
              <form onSubmit={handleDonationSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="nome" className="block text-cyan-700 dark:text-cyan-200 mb-2">Nome Completo*</label>
                  <input
                    type="text"
                    id="nome"
                    name="nome"
                    value={donationFormData.nome}
                ...
                <div>
                  <label htmlFor="email" className="block text-cyan-700 dark:text-cyan-200 mb-2">Email*</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div>
                  <label htmlFor="telefone" className="block text-cyan-700 dark:text-cyan-200 mb-2">Telefone*</label>
                  <input
                    type="tel"
                    id="telefone"
                    name="telefone"
                    value={donationFormData.telefone}
                    onChange={handleDonationInputChange}
                    required
                    className="w-full px-4 py-3 rounded-lg border border-cyan-300 dark:border-cyan-600 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-cyan-700 dark:text-white"
                  />
                ...
                <div>
                  <label htmlFor="mensagem" className="block text-cyan-700 dark:text-cyan-200 mb-2">Mensagem</label>
                  <textarea
                    id="mensagem"
                    name="mensagem"
                    value={donationFormData.mensagem}
                    onChange={handleDonationInputChange}
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-cyan-300 dark:border-cyan-600 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-cyan-700 dark:text-white"
                  ></textarea>
                ...
                <button
                  type="submit"
                  className="bg-cyan-500 text-white px-8 py-3 rounded-lg hover:bg-cyan-600 transition-all flex items-center justify-center space-x-2 w-full md:w-auto"
      ...
      {showDonationConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-6 w-full max-w-md">
            ...
            <p className="text-cyan-700 dark:text-cyan-200 mb-6">
              Você está prestes a fazer uma doação para AMODES. Deseja continuar?
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <p className="text-cyan-400">servimos para o mundo</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#equipe" className="text-cyan-400 hover:text-cyan-300 transition-colors">Equipe</a></li>
                <li><a href="#projetos" className="text-cyan-400 hover:text-cyan-300 transition-colors">Atividades</a></li>
                <li><a href="#galeria" className="text-cyan-400 hover:text-cyan-300 transition-colors">Galeria</a></li>
                <li><a href="#contato" className="text-cyan-400 hover:text-cyan-300 transition-colors">Contato</a></li>
                <li><a href="#doacoes" className="text-cyan-400 hover:text-cyan-300 transition-colors">Doações</a></li>
              </ul>
            </div>
            
            {/* Coluna 3 - Províncias */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-cyan-400">Províncias de Atuação</h4>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <p className="flex items-center space-x-3 text-cyan-400">
                  ...
                  <span className="break-all">contato@amodes.com</span>
                </p>
                <p className="flex items-center space-x-3 text-cyan-400">
          ...
          >
            <div className="p-6">
              ...
              {selectedPublicacao.fotos && selectedPublicacao.fotos.length > 0 ? (
                <img
                  src={selectedPublicacao.fotos[0]}
